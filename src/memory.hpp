...
private:
	...
	static const uint32_t ADDR_NULL_END=0x00000004;	//0x00000004 ~ 0x10000000: length 0xFFFFFFC
	static const uint32_t ADDR_INSTR=0x10000000;	//0x10000000 ~ 0x11000000: length 0x1000000
	static const uint32_t ADDR_INSTR_END=0x11000000;	//0x11000000 ~ 0x20000000: length=0xF000000
	static const uint32_t ADDR_DATA=0x20000000;
	static const uint32_t ADDR_DATA_END=0x24000000;	//0x24000000 ~ 0x30000000: length=0xC000000
